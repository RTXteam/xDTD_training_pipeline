...
def generate_expert_path_transition(args):
    ...
    args.logger.info("Generate expert transitions to " + expert_trans_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_name", type=str, help="log file name", default="generate_expert_path_transition.log")
